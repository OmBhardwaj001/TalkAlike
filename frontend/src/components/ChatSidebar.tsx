          ...
          <div className="space-y-4 h-full">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-lg bg-gray-800  border border-gray-700 text-white placeholder-gray-400"
                value={searchQuery}
            ...
            <div className="space-y-2 overflow-y-auto h-full pb-4">
              {users
                ...
                .map((u) => (
                  <button
                    key={u._id}
                    className="w-full text-left p-4 rounded-lg border border-gray-700 hover:border-gray-600 bg-gray-800 transition-colors"
                ...
                <button
                  ...
                  className={`w-full text-left p-4 rounded-lg transition-colors ${
                    isSelected
                      ...
                      : "borer border-gray-700  hover:bg-gray-600"
                  } `}
                >
