        ...
        <div className='bg-gray-800 rounded-lg border border-gray-700  shadow-lg'>
            ...
            <div className='p-8'>
                <div className='space-y-6'>
                    <div>
                        <label className='blocl text-sm font-semibold text-gray-300 mb-3'> Display Name</label>
                        {
                            ...
                            <div className='flex gap-3 '>
                                <button type='submit' className='gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg'>
                                    <Save className='w-4 h-4 '/>
                                    Save Changes
                                </button>

                                <button type='button' onClick={editHandler}
                                className='gap-2 px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg'
                                >
                                    Cancel
                                </button>
                            </div>
                            ...
                            <div className='flex items-center justify-between p-4 bg-gray-700 rounded-lg border border-gray-600'>
                                ...
                                className='gap-2 px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-semibold rounded-lg cursor-pointer'
                                >
                                    Edit
                                </button>
                            </div>
